...
export default function MovieDetails()
{
    ...
    {
        console.log('! rate');
        console.log(urlRatings, rate, id);
    ...
    return (
        movie ? <div>
            ...
            | Yor vote: <Ratings maximumValue={5} selectedValue={movie.userVote} onChange={handleRate} /> | Average Vote: {movie.averageVote}
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    {movie.actors?.map(actor =>
                        <div key={actor.id} style={{ marginBottom: '2px' }}>
                            ...
                            />
                            <span style={{ display: 'inline-block', width: '200px', marginLeft: '1rem' }}>{actor.firstName} {actor.middleName ?? ""} {actor.lastName}</span>
